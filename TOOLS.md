...
| **codebase-memory-mcp** | Memory & RAG Systems | https://github.com/DeusData/codebase-memory-mcp | 92 | 88 | 95 | 85 | 91 | S | #mcp-compatible #code-memory #local-first #rag | **Primary** code-graph MCP for Grok (ADR-0002). Bootstrap `--with-codebase-memory`. Pin `ee68144`. **Smoke:** `make smoke-codebase-memory`. Decision vs Graphify: [docs/evaluation/codebase-memory-vs-graphify.md](docs/evaluation/codebase-memory-vs-graphify.md). |
