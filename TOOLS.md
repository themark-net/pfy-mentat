...
| **Finn Loop / eval-loop / 8-exits patterns** | Agent Frameworks & Orchestration | docs / X Entries 024 · 027 · 031 · 032 · **068** | 92 | 90 | 92 | 88 | 91 | A | #agentic #loops #evaluation #human-in-loop #stop-conditions #exits | Loop engineering pedagogy + complete exit taxonomy. **Entry 068** (hanakoxbt): 8 mandatory exits (goal met, turn/budget/wall-clock caps, no-progress hash, human interrupt, error threshold, external event). Canonical checklist for any new loop skill or harness. |
