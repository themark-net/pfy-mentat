...
## Evaluation Notes & Known Gaps (v0.2)
...
*Table generated/maintained manually in v0.2; future versions may parse from data/tools.json for automated dashboard or pipeline scoring. 'Read a paper' formalized as recurring use case. ATG prototype repo created as active testing space.*