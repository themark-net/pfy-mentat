...
async function attach(id){
  ...
  try{
    ...
    if(j && j.ok && j.usable!==false){
      ...
      else if(id==='opencode'||id==='hermes'||id==='grok'||id==='codex'||id==='claude'||id==='claude-code') paintSessionReach('FAIL');
    }else{
      ...
      attachKind='fail';
      if(id==='opencode'||id==='hermes'||id==='grok'||id==='codex'||id==='claude'||id==='claude-code') paintSessionReach((j&&j.session_reach)||'FAIL');
      paintAttach();
    ...
    attachKind='fail';
    if(id==='opencode'||id==='hermes'||id==='grok'||id==='codex'||id==='claude'||id==='claude-code') paintSessionReach('FAIL');
    paintAttach();
    return;
  }
  paintAttach();
