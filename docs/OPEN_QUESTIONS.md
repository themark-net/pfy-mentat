...
1. **OQ-0005** — How should Grok participate in agent-cage?  
2. **OQ-0006** — How aggressive should skill ports be?  
3. **OQ-0002** — Confirm eval harness MVP = LiteLLM + Ollama smoke (recommended).
