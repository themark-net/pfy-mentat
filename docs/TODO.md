...
**Session (2026-07-26):** T-0091 **phase 1** STT edge live (`make smoke-voice-stt`). Human: [human-decision-inventory.md](ops/human-decision-inventory.md) (**0 required** for p1; optional VOICE-BATCH for path B/C).
...
| T-0091 | P1 | doing | **Voice → tool-capable agent** (p1 STT edge **done**; p2+ TTS/remote open) | [OQ-0010](open-questions/OQ-0010-voice-agent-channel.md) | T-0085 | `make smoke-voice-stt`; [voice-agent-channel.md](ops/voice-agent-channel.md); edge→worker/monitor not Hermes primary |
