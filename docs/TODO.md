...
| T-0017 | P2 | todo | **Optional:** first-party `investigate` RCA skill (gstack method rewrite, not raw snapshot) | — | T-0014 | See [gstack-skill-port-comparison.md](ops/gstack-skill-port-comparison.md); operator go required |
