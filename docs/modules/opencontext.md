...
- Callers: `scripts/pfy` (`cmd_context`, `apply_opencontext_env` in `exec_harness`); Attach `pfy_attach_usable_196.py`, `pfy_attach_usable_202.py`, `pfy_attach_usable_220.py`, `pfy_attach_usable_221.py`, `pfy_enterable_162_b_p1b.py`.
