#!/usr/bin/env python3
"""Assembler for scripts/pfy-board.py — cite #150. Concat body parts then exec."""
...
# Expected exact paint source (board_patched.py)
if len(body) != 50107:
    raise SystemExit(f"pfy-board: bad assembled len {len(body)} want 50107")
