...
EXPECTED = {
    "hermes": {
        ...
        "missing": {"copy": "./pfy start hermes", "error": "hermes missing", "id": "hermes", "live": "FAIL", "ok": False, "session_reach": "FAIL", "usable": False},
    ...
    "claude-code": {
        ...
        "missing": {"copy": "./pfy start claude", "error": "claude missing", "id": "claude", "live": "FAIL", "next_step": "npm install -g @anthropic-ai/claude-code", "ok": False, "session_reach": "FAIL", "usable": False},
