...
- **Notes**: Role specialization + Think→Plan→Build→Review→Test→Ship→Reflect is the portable value. Complements marketing-council (T-0011 first-party), mattpocock paths subset (tdd/code-review/to-spec), one-shot, cage smokes. **Do not** clone full gstack into this catalog. Optional later: promote one small skill as paths snapshot only if proven essential.
- **Status**: Triple-write complete; **T-0014 docs recipes shipped** 2026-07-12
